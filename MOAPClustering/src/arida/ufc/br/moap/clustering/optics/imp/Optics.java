...
//import arida.ufc.br.moap.clustering.spi.IClusteringAlgorithm;
...
// */
//public class Optics<T> extends IClusteringAlgorithm {
//
...
//    private IDistanceFunction<T> distanceFunction;
...
//
//    /*
//     * (non-Javadoc) @see mf.core.algorithm.spi.Algorithm#execute()
//     */
//    @Override
//    public void execute() {
...
//                        this.distanceFunction.distance(object.getObject(), p.getObject()));
//
...
//        for (OpticsObject<T> p : setOfObjects) {
//            if (!p.equals(object)) {
//                if (distanceFunction.distance((T) p.getObject(), (T) object.getObject()) <= this.epsilon) {
//                    neighbors.add(p);
//                }
//            }
//        }
...
//            double distance = distanceFunction.distance(q.getObject(), object.getObject());
...
//        return "This is the Optics Algorithm.";
//    }
//
//    @Override
