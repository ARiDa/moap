 ...
 * @author igobrilhante
 */
public class UnserendipityTest {
    
    public UnserendipityTest() {
    }
    ...
    /**
     * Test of getUnserendipity method, of class Unserendipity.
     */
    @Test
    public void testGetUnserendipity() {
        System.out.println("getUnserendipity");
        ...
        Unserendipity instance = new Unserendipity(dataset, ws1.getRecommendation());
        double expResult = 0.2682459513747883;
        double result = instance.getUnserendipity();
        System.out.println("Unserendipity: "+result);
