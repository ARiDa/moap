...
public class UserNetworkExample1 {
	public static void main(String[] args){

		// Example of User Network from Trajectory of Cluster Pois

		String query = "select * from stop_cpoi_1200s_150m where (extract(epoch from end_time)-extract(epoch from start_time)) <= 25200 order by userid,start_time ";
...
//		System.out.println(comps.getReport());
		...
		try {
			Network network = new Network("cuser_network");
